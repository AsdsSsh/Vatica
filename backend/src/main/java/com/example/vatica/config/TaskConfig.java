...
public class TaskConfig {
    ...
    @Bean
    TaskBlackboard taskBlackboard(ModelRegistry registry, ModelGateway modelGateway,
            ContextBudget contextBudget, ObjectMapper mapper) {
        return new TaskBlackboard(registry, modelGateway, contextBudget, mapper);
    }
}
